...
export interface IUser extends Document {
  ...
  passwordResetIdExpires: number | null;
  isActivated: boolean;
  activationId: string | null;
  activationIdExpires: number | null;
  lastVisit: Date;
  isOnline: boolean;
...
const UserSchema = new Schema<IUser>(
  {
    ...
    passwordResetIdExpires: { type: Number || null, default: null },
    isActivated: { type: Boolean, default: false },
    activationId: { type: String, default: null },
    activationIdExpires: { type: Number, default: null },
