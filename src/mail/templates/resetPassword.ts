                                                            ...
                                                            <tr>
                                                               <td style="padding-right: 0px; padding-left: 0px" align="center">
                                                                  <img
                                                                     align="center"
                                                                     border="0"
                                                                     src="https://i.pinimg.com/originals/94/0e/2b/940e2bc2526cee1b3cbfb543e92e7a1f.png"
                                                                     alt="Banner"
                                                                     title="Banner"
                                                                     style="
                                                                        outline: none;
                                                         ...
                                                         >
                                                            <p style="font-size: 14px; line-height: 180%">
                                                               <span
                                                                  ...
                                                                  "
                                                                  ><strong
                                                                     ><span style="line-height: 32.4px; font-size: 18px"
                                                            ...
                                                            <p style="font-size: 14px; line-height: 180%">
                                                               <span
                                                                  style="
                                                                     ...
                                                                     line-height: 25.2px;
                                                                  "
                                                                  >Вы запросили сброс пароля на WebChat2023. Чтобы продолжить,нажмите на кнопку ниже:</span
                                                               >
                                                            </p>
                                                         </div>
                                                      </td>
                                                ...
                                                <tbody>
                                                   <tr>
                                                      ...
                                                      >
                                                         ...
                                                         [endif]-->
                                                         <div align="center">
                                                            <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://unlayer.com" style="height:57px; v-text-anchor:middle; width:232px;" arcsize="77%"  stroke="f" fillcolor="#33428d"><w:anchorlock/><center style="color:#FFFFFF;font-family:arial,helvetica,sans-serif;"><![endif]-->
                                                            <a
                                                               href="${link}"
                                                               target="_blank"
                                                               class="v-button"
                                                            ...
                                                            >
                                                               <span
                                                                  ...
                                                                  ><strong>Создать новый пароль</strong></span
                                                               >
                                                            </a>
                                                            ...
                                                            <p style="font-size: 14px; line-height: 170%">
                                                               <span
                                                                  style="
                                                                     ...
                                                                     line-height: 23.8px;
                                                                  "
                                                                  >С уважением, <a href=${process.env.CLIENT_URL}
                                                                     ><strong>webchat2023.com</strong></a
                                                                  ></span
                                                               >
                                                            </p>
                                                         </div>
